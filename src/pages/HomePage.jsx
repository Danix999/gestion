      ...
      return (
        <div className="space-y-16">
          ...
          >
            ...
            >
              Conecta con profesionales talentosos o muestra tus habilidades al mundo. Encuentra y ofrece servicios de calidad.
            </motion.p>
            <motion.div
          ...
          <section className="grid md:grid-cols-3 gap-8">
            {[
              { icon: <Search size={48} className="text-purple-400" />, title: "Encuentra Expertos", description: "Busca entre una amplia gama de servicios y profesionales calificados." },
              { icon: <Briefcase size={48} className="text-green-400" />, title: "Ofrece Tus Servicios", description: "Crea tu perfil, publica tus servicios y alcanza nuevos clientes." },
              { icon: <Users size={48} className="text-blue-400" />, title: "Comunidad Confiable", description: "Valoraciones y comentarios para asegurar la calidad y confianza." },
            ].map((feature, i) => (
              <motion.div
                key={feature.title}
                custom={i}
              ...
              >
                ...
                <h3 className="text-2xl font-semibold text-center text-yellow-300 mb-3">{feature.title}</h3>
          ...
          <section className="text-center py-16">
             <h2 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 via-pink-400 to-red-400 mb-8">¿Listo para empezar?</h2>
             <img  class="w-full max-w-4xl mx-auto rounded-lg shadow-2xl mb-8" alt="Collage de profesionales trabajando" src="https://images.unsplash.com/photo-1492448497576-45b1efcdc02c" />
             <Button 
                size="lg" 
                onClick={() => navigate('/auth')}
